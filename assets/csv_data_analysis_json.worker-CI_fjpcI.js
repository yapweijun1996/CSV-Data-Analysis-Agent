...
class Emitter {
  constructor(options) {
    ...
    this._leakageMon = ((_a2 = this._options) == null ? void 0 : _a2.leakWarningThreshold) ? new LeakageMonitor((options == null ? void 0 : options.onListenerError) ?? onUnexpectedError, ((_b2 = this._options) == null ? void 0 : _b2.leakWarningThreshold) ?? _globalLeakWarningThreshold, (_c3 = this._options) == null ? void 0 : _c3.leakWarningName) : void 0;
    this._perfMon = ((_d2 = this._options) == null ? void 0 : _d2._profName) ? new EventProfiling(this._options._profName) : void 0;
    this._deliveryQueue = (_e2 = this._options) == null ? void 0 : _e2.deliveryQueue;
  }
  dispose() {
    var _a2, _b2, _c3, _d2;
    if (!this._disposed) {
  ...
  get event() {
    this._event ?? (this._event = (callback, thisArgs, disposables) => {
      var _a2, _b2, _c3, _d2, _e2, _f2, _g, _h;
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        const message = `[${this._leakageMon.name}] REFUSES to accept new listeners because it exceeded its threshold by far (${this._size} vs ${this._leakageMon.threshold})`;
        console.warn(message);
        const tuple = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1];
        const kind = tuple[1] / this._size > 0.3 ? "dominated" : "popular";
        const error = new ListenerRefusalError(kind, `${message}. HINT: Stack shows most frequent listener (${tuple[1]}-times)`, tuple[0], this._size, (_a2 = this._options) == null ? void 0 : _a2.leakWarningName);
      ...
      if (!this._listeners) {
        ...
        (_f2 = (_e2 = this._options) == null ? void 0 : _e2.onDidAddFirstListener) == null ? void 0 : _f2.call(_e2, this);
      ...
      (_h = (_g = this._options) == null ? void 0 : _g.onDidAddListener) == null ? void 0 : _h.call(_g, this);
      this._size++;
...
function resolveAmdNodeModulePath(nodeModuleName, pathInsideNodeModule) {
  ...
  Boolean((_d2 = product ?? ((_c3 = (_b2 = (_a2 = globalThis.vscode) == null ? void 0 : _a2.context) == null ? void 0 : _b2.configuration()) == null ? void 0 : _c3.product)) == null ? void 0 : _d2.commit);
